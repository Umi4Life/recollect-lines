...
def parser() -> argparse.ArgumentParser:
    ...
    create.add_argument("--result-schema", dest="result_schema", default=None, help="Normalized result schema (plain-summary, evidence-report, review-findings, implementation-report, verified-investigation-report).")
    create.add_argument(
        "--task-category",
        dest="task_category",
        default=None,
